...
<div class="container">
  ...
  <div class="footer">
    ...
    <div class="footer-row">
      <a
        class="author"
        href="https://github.com/tuanjie/figma-mcp"
        target="_blank"
      >
        <img
      ...
      <div class="links">
        <a
          class="footer-link"
          href="https://github.com/tuanjie/figma-mcp/issues/new?labels=bug"
          target="_blank"
          title="Report a bug"
        >
        ...
        <a
          class="footer-link"
          href="https://github.com/tuanjie/figma-mcp/issues/new?labels=enhancement&title=Feature+request%3A+"
          target="_blank"
